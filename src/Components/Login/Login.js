...
function Login({setLoginConferencia}){
    ...
    return(
        <LoginContainer>
            ...
            <Botao onClick={confereLogin} width = '50%' padding='15px 0px' margin='20px 0px' border='0.5px solid black' border_radius='10px' boxshadow='2px 2px 5px black'>Entrar</Botao>
        </LoginContainer>
    )
}
